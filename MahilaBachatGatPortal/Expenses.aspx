<%@ Page Title="Expense Management" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Expenses.aspx.cs" Inherits="Expenses" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<style>
.summary-card { padding: 20px; border-radius: 6px; margin-bottom: 20px; color: white; }
.summary-expense { background: #d9534f; }
...
<h2><span class="glyphicon glyphicon-minus"></span> Expense Management</h2>
<hr />
...
<div class="amount">₹ <asp:Label ID="lblTotalExpenses" runat="server" Text="0.00"></asp:Label></div>
</div>
</div>
...
<div class="amount">₹ <asp:Label ID="lblCurrentMonthExpenses" runat="server" Text="0.00"></asp:Label></div>
</div>
</div>
</div>
...
<asp:TextBox ID="txtExpenseDate" runat="server" CssClass="form-control" TextMode="SingleLine"></asp:TextBox>
</div>
</div>
</div>
...
<asp:ListItem Text="Office Expenses" Value="Office Expenses"></asp:ListItem>
<asp:ListItem Text="Meeting Expenses" Value="Meeting Expenses"></asp:ListItem>
<asp:ListItem Text="Travel Expenses" Value="Travel Expenses"></asp:ListItem>
...
<asp:ListItem Text="Bank Charges" Value="Bank Charges"></asp:ListItem>
...
<div class="form-group">
<asp:Button ID="btnSave" runat="server" Text="Save Expense" CssClass="btn btn-danger" OnClick="btnSave_Click" />
&nbsp;
...
<div class="row">
<div class="col-md-8">
<asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search by expense type, paid to or receipt number"></asp:TextBox>
</div>
...
<asp:GridView ID="gvExpenses" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped table-hover" DataKeyNames="ExpenseID" OnRowCommand="gvExpenses_RowCommand">
<Columns>
...
<ItemTemplate>
<asp:LinkButton ID="btnDelete" runat="server" CommandName="DeleteExpense" CommandArgument='<%# Eval("ExpenseID") %>' CssClass="btn btn-danger btn-xs" OnClientClick="return confirm('Are you sure you want to delete this expense entry?');"><span class="glyphicon glyphicon-trash"></span> Delete</asp:LinkButton>
</ItemTemplate>
</asp:TemplateField>
</Columns>
</asp:GridView>
