<%@ Page Title="Loan Management" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeFile="Loans.aspx.cs" Inherits="Loans" %>
    ...
    <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtLoanTermMonths"
                                runat="server"
                                CssClass="form-control"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlLoanStatus"
                                runat="server"
                                CssClass="form-control">

                                <asp:ListItem Text="Pending"
                                    Value="Pending"></asp:ListItem>

                                <asp:ListItem Text="Approved"
                                    Value="Approved"></asp:ListItem>

                                <asp:ListItem Text="Rejected"
                                    Value="Rejected"></asp:ListItem>

                                <asp:ListItem Text="Distributed"
                                    Value="Distributed"></asp:ListItem>

                                <asp:ListItem Text="Completed"
                                    Value="Completed"></asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="txtSearch"
                            runat="server"
                            CssClass="form-control"
                            placeholder="Search member name, member code or status">
                        </asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="btnApprove"
                                        runat="server"
                                        CommandName="ApproveLoan"
                                        CommandArgument='<%# Eval("LoanID") %>'
                                        CssClass="btn btn-success btn-sm"
                                        OnClientClick="return confirm('Approve this loan?');">
                                    ...
                                    <asp:LinkButton ID="btnReject"
                                        runat="server"
                                        CommandName="RejectLoan"
                                        CommandArgument='<%# Eval("LoanID") %>'
                                        CssClass="btn btn-danger btn-sm"
                                        OnClientClick="return confirm('Reject this loan?');">
                                    ...
                                    <asp:LinkButton ID="btnDistribute"
                                        runat="server"
                                        CommandName="SelectDistribution"
                                        CommandArgument='<%# Eval("LoanID") %>'
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <asp:HiddenField ID="hfDistributionLoanID"
                    runat="server" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDistributionLoanID"
                                runat="server"
                                CssClass="form-control"
                                ReadOnly="true">
                            </asp:TextBox>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDistributionMember"
                                runat="server"
                                CssClass="form-control"
                                ReadOnly="true">
                            </asp:TextBox>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtApprovedAmount"
                                runat="server"
                                CssClass="form-control"
                                ReadOnly="true">
                            </asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDistributionDate"
                                runat="server"
                                CssClass="form-control"
                                TextMode="SingleLine">
                            </asp:TextBox>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDistributionAmount"
                                runat="server"
                                CssClass="form-control">
                            </asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtDistributionRemarks"
                        runat="server"
                        CssClass="form-control"
                        TextMode="MultiLine"
                        Rows="2">
