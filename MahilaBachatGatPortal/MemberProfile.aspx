<%@ Page Language="C#"
    ...
    CodeFile="MemberProfile.aspx.cs"
...
<asp:Content ID="Content2"
    ...
    <p class="page-subtitle">
        Select your Bachat Gat and name to view your profile details.
    </p>
        ...
        <div class="section-panel">
            ...
            <div class="table-responsive">
                ...
                <asp:GridView
                    ...
                    EmptyDataText="No savings records found.">
                ...
                <asp:GridView
                    ...
                    <Columns>
                        ...
                        <asp:BoundField
                            ...
                            HeaderText="Term (Months)" />

                        <asp:BoundField
                            DataField="EMIAmount"
                            HeaderText="EMI Amount"
                            DataFormatString="₹ {0:N2}" />
        ...
        <div class="section-panel">
            ...
            <div class="table-responsive">
                ...
                <asp:GridView
                    ...
                    AutoGenerateColumns="False"
                    CssClass="table table-bordered table-hover"
                    EmptyDataText="No repayment records found.">
