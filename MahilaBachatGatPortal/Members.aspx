...
<asp:TextBox ID="txtFatherHusband" runat="server" CssClass="form-control"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label>Date of Birth</label>
<asp:TextBox ID="txtDOB" runat="server" TextMode="SingleLine" CssClass="form-control"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
...
<div class="col-md-4">
<asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search by Member Name or Mobile"></asp:TextBox>
</div>
<div class="col-md-2">
...
<asp:GridView ID="gvMembers" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" DataKeyNames="MemberID" OnRowCommand="gvMembers_RowCommand">
<Columns>
<asp:BoundField DataField="MemberID" HeaderText="ID" />
<asp:BoundField DataField="MemberCode" HeaderText="Code" />
...
<ItemTemplate>
<asp:LinkButton ID="btnEdit" runat="server" Text="Edit" CssClass="btn btn-warning btn-xs" CommandName="EditMember" CommandArgument='<%# Eval("MemberID") %>'></asp:LinkButton>
&nbsp;
<asp:LinkButton ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-danger btn-xs" CommandName="DeleteMember" CommandArgument='<%# Eval("MemberID") %>' OnClientClick="return confirm('Are you sure you want to delete this member?');"></asp:LinkButton>
</ItemTemplate>
</asp:TemplateField>
</Columns>
