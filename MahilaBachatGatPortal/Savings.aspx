...
<asp:Content ID="Content2"
    ...
    <p class="text-muted">
        Record and manage monthly member savings.
    </p>
    ...
    <div class="grid-panel">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtSearch"
                        runat="server"
                        CssClass="form-control"
                        placeholder="Search by Member Name, Code or Receipt Number">
                    </asp:TextBox>
        ...
        <div class="table-responsive">
            ...
            <asp:GridView ID="gvSavings"
                runat="server"
                AutoGenerateColumns="False"
                CssClass="table table-bordered table-hover"
                DataKeyNames="SavingID"
                OnRowCommand="gvSavings_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:BoundField
                        DataField="SavingMonth"
                        HeaderText="Saving Month"
                    ...
                    <asp:TemplateField HeaderText="Action">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton
                                ...
                                CommandName="DeleteSaving"
                                CommandArgument='<%# Eval("SavingID") %>'
                                OnClientClick="return confirm('Are you sure you want to delete this savings record?');">
                            </asp:LinkButton>
