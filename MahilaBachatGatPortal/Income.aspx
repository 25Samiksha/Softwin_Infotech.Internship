    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="summary-card summary-month">
                ...
                <div class="amount">
                    ₹ <asp:Label ID="lblCurrentMonthIncome"
                        runat="server"
                        Text="0.00"></asp:Label>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlIncomeType"
                        runat="server"
                        CssClass="form-control">

                        <asp:ListItem Text="-- Select Income Type --"
                            Value="">
                        </asp:ListItem>

                        <asp:ListItem Text="Product Sales"
                            Value="Product Sales">
                        </asp:ListItem>

                        <asp:ListItem Text="Membership Fee"
                            Value="Membership Fee">
                        </asp:ListItem>

                        <asp:ListItem Text="Interest Received"
                            Value="Interest Received">
                        </asp:ListItem>

                        <asp:ListItem Text="Government Grant"
                            Value="Government Grant">
                        </asp:ListItem>

                        <asp:ListItem Text="Donation"
                            Value="Donation">
                        </asp:ListItem>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtReceivedFrom"
                        runat="server"
                        CssClass="form-control">
                    </asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <asp:TextBox ID="txtSearch"
                    runat="server"
                    CssClass="form-control"
                    placeholder="Search by income type, received from or receipt number">
                </asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="btnDelete"
                                ...
                                OnClientClick="return confirm('Are you sure you want to delete this income entry?');">
