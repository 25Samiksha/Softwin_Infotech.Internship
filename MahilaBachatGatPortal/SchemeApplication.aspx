<%@ Page Title="Scheme Applications" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="SchemeApplication.aspx.cs" Inherits="SchemeApplication" %>
...
<div class="panel-heading">Scheme Application</div>
...
<asp:TextBox ID="txtApplicationNumber" runat="server" CssClass="form-control"></asp:TextBox>
</div>
<div class="col-md-4">
<label>Status</label>
...
<asp:TextBox ID="txtDocuments" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3"></asp:TextBox>
</div>
<div class="col-md-6">
<label>Remarks</label>
...
<asp:TextBox ID="txtRejectionReason" runat="server" CssClass="form-control"></asp:TextBox>
</div>
</div>

<br />

<asp:Button ID="btnSave" runat="server" Text="Save Application" CssClass="btn btn-success" OnClick="btnSave_Click" />
<asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn btn-default" OnClick="btnClear_Click" />
</div>
</div>

<div class="panel panel-default">
<div class="panel-heading">Search Applications</div>
<div class="panel-body">
<div class="row">
<div class="col-md-10">
<asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search member, scheme or application number"></asp:TextBox>
</div>
<div class="col-md-2">
...
<asp:GridView ID="gvApplications" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" DataKeyNames="ApplicationID" OnRowCommand="gvApplications_RowCommand">
<Columns>
...
<asp:ButtonField ButtonType="Button" CommandName="EditApplication" Text="Edit" ControlStyle-CssClass="btn btn-warning btn-xs" />
<asp:ButtonField ButtonType="Button" CommandName="DeleteApplication" Text="Delete" ControlStyle-CssClass="btn btn-danger btn-xs" />
</Columns>
</asp:GridView>
</div>
</asp:Content>