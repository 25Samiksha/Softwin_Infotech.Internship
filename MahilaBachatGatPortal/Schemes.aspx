<%@ Page Title="Government Schemes" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeFile="Schemes.aspx.cs" Inherits="Schemes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtEligibility" runat="server"
                            CssClass="form-control"
                            TextMode="MultiLine"
                            Rows="3"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtBenefits" runat="server"
                            CssClass="form-control"
                            TextMode="MultiLine"
                            Rows="3"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtRequiredDocuments" runat="server"
                            CssClass="form-control"
                            TextMode="MultiLine"
                            Rows="3"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtApplicationProcess" runat="server"
                            CssClass="form-control"
                            TextMode="MultiLine"
                            Rows="3"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtOfficialWebsite" runat="server"
                            CssClass="form-control"></asp:TextBox>
                    </div>
        ...
        <asp:GridView ID="gvSchemes" runat="server"
            AutoGenerateColumns="False"
            CssClass="table table-bordered table-striped"
            DataKeyNames="SchemeID"
            OnRowCommand="gvSchemes_RowCommand">

            <Columns>

                <asp:BoundField DataField="SchemeID"
                    HeaderText="ID" />
